...
Phase 4's implementers commit — so the **feature branch was created before Phase 4 ran** (never
...
## Verification
<the actual build/test/lint commands run, and their result — paste the evidence from Phase 5>
...
Capture the **PR URL** — Phase 9 needs it.

**Exit:** an open PR, its URL captured for the handoff.

**Exit receipt example:**
`✅ Phase 6 (PR) — confirmed by human — pushed abc-123-rate-limiting (7 commits), opened https://github.com/org/repo/pull/456 ([ABC-123] …, Fixes ABC-123)`
