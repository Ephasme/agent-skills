 ...
 * Useful for showing the user a skill's process flows.
 *
...
function main() {
  ...
  if (!skillDirArg) {
    ...
    console.error('  ./render-graphs.js <skill-directory>');
    console.error('  ./render-graphs.js <skill-directory> --combine');
    process.exit(1);
  }
